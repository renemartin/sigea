...
namespace SIGEA.Classes.Entities
{
    ...
    partial void DeleteComparableInmobiliario(ComparableInmobiliario instance);
		...
		public SIGEADataContext() : 
				base(global::SIGEA.Classes.Properties.Settings.Default.SIGEAConnectionString2, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnactivoChanged();
		...
		[Association(Name="AvaluoInmobiliario_EnfoqueCostos", Storage="_EnfoqueCostos", ThisKey="idAvaluo", OtherKey="idAvaluo", IsUnique=true, IsForeignKey=false)]
		...
		[Association(Name="AvaluoInmobiliario_EnfoqueIngresos", Storage="_EnfoqueIngresos", ThisKey="idAvaluo", OtherKey="idAvaluo", IsUnique=true, IsForeignKey=false)]
		...
		[Association(Name="AvaluoInmobiliario_EnfoqueMercado", Storage="_EnfoqueMercado", ThisKey="idAvaluo", OtherKey="idAvaluo", IsUnique=true, IsForeignKey=false)]
    ...
    partial void Onentre2Changed();
		...
		[Association(Name="Direccion_ComparableInmobiliario", Storage="_ComparableInmobiliario", ThisKey="idDireccion", OtherKey="idDireccion", IsUnique=true, IsForeignKey=false)]
			...
			set
			{
							...
							|| (this._ComparableInmobiliario.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.Direccion = null;
					}
					this._ComparableInmobiliario.Entity = value;
					if ((value != null))
					{
						value.Direccion = this;
					}
	...
	public partial class EnfoqueCostos : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<decimal> _valorTerreno;
    ...
    partial void OnvalorTerrenoChanging(System.Nullable<decimal> value);
    partial void OnvalorTerrenoChanged();
    ...
    partial void OnhomologacionLoteTipoChanged();
		...
		[Column(Storage="_valorTerreno", DbType="Money")]
		public System.Nullable<decimal> valorTerreno
		{
			get
			{
				return this._valorTerreno;
			}
			set
			{
				if ((this._valorTerreno != value))
				{
					this.OnvalorTerrenoChanging(value);
					this.SendPropertyChanging();
					this._valorTerreno = value;
					this.SendPropertyChanged("valorTerreno");
					this.OnvalorTerrenoChanged();
				}
			}
		}
		...
		public AvaluoInmobiliario AvaluoInmobiliario
		{
			...
			set
			{
							...
							|| (this._AvaluoInmobiliario.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._AvaluoInmobiliario.Entity = null;
						previousValue.EnfoqueCostos = null;
					}
					this._AvaluoInmobiliario.Entity = value;
					if ((value != null))
					{
						value.EnfoqueCostos = this;
						this._idAvaluo = value.idAvaluo;
					}
					else
					{
		...
		public AvaluoInmobiliario AvaluoInmobiliario
		{
			...
			set
			{
							...
							|| (this._AvaluoInmobiliario.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._AvaluoInmobiliario.Entity = null;
						previousValue.EnfoqueIngresos = null;
					}
					this._AvaluoInmobiliario.Entity = value;
					if ((value != null))
					{
						value.EnfoqueIngresos = this;
						this._idAvaluo = value.idAvaluo;
					}
					else
					{
		...
		public AvaluoInmobiliario AvaluoInmobiliario
		{
			...
			set
			{
							...
							|| (this._AvaluoInmobiliario.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._AvaluoInmobiliario.Entity = null;
						previousValue.EnfoqueMercado = null;
					}
					this._AvaluoInmobiliario.Entity = value;
					if ((value != null))
					{
						value.EnfoqueMercado = this;
						this._idAvaluo = value.idAvaluo;
					}
					else
					{
		...
		public Direccion Direccion
		{
			...
			set
			{
							...
							|| (this._Direccion.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._Direccion.Entity = null;
						previousValue.ComparableInmobiliario = null;
					}
					this._Direccion.Entity = value;
					if ((value != null))
					{
						value.ComparableInmobiliario = this;
						this._idDireccion = value.idDireccion;
					}
					else
					{
