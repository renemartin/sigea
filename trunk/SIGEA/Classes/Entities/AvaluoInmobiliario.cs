        ...
        public static object GetRegistro(SIGEADataContext data_context, int idAvaluo)
        {
            var avaluo_query =
                ...
                select new
                {
                    ...
                    supTerreno = a.Inmueble.SuperficieTerreno,
                    supConstruida = a.Inmueble.SuperficieConstruida,
                    supAccesoria = a.Inmueble.SuperficieAccesoria,
                    supVendible = a.Inmueble.SuperficieVendible,
                    valorMercado = 0,
                    valorTerreno = 0,
                    valorConstruccion = 0,
